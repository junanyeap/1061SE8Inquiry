  ...
  <div class="container" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-size:25px">
      <ul class="nav navbar-nav" >
        ...
        <li><a href="../Views/search.php" style="color:white;font-weight:bold">查詢清單</a></li>
        <li><a href="../Views/new_upload_example.php" style="color:white;font-weight:bold">上傳圖片</a></li>
        <li><a href="../Views/photoview.php" style="color:white;font-weight:bold">瀏覽圖庫</a></li>
      </ul>
